...
class VehicleLoanForm extends StatefulWidget {
  const VehicleLoanForm({Key? key}) : super(key: key);

  @override
  _VehicleLoanFormState createState() => _VehicleLoanFormState();
}

class _VehicleLoanFormState extends State<VehicleLoanForm> {
  List<String> listVehicle = <String>['Vehicle','Car','Bus','lorry','Van','Three Wheel'];
  ...
  String dropdownVehicle = 'Vehicle';
                    ...
                    children:[
                      Container(
                        ...
                        child: DropdownButton<String>(
                          ...
                          items: listVehicle.map<DropdownMenuItem<String>>(
                                (String value){
