...
class EducationDetailPage extends StatefulWidget {
  const EducationDetailPage({Key? key}) : super(key: key);

  @override
  _EducationDetailPageState createState() => _EducationDetailPageState();
}
          ...
          Container(
            ...
            decoration: const BoxDecoration(
                image: DecorationImage(
                    image: NetworkImage("https://i.pinimg.com/736x/11/b0/8b/11b08b3b288ad4be8c1632e601f00b5b.jpg"),
                    fit: BoxFit.cover
                )
            ),
          ),
