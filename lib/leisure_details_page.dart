...
class LeisureDetailPage extends StatefulWidget {
  const LeisureDetailPage({Key? key}) : super(key: key);

  @override
  _LeisureDetailPageState createState() => _LeisureDetailPageState();
}

class _LeisureDetailPageState extends State<LeisureDetailPage> {
  @override
          ...
          Container(
            ...
            decoration: const BoxDecoration(
                image: DecorationImage(
                    image: NetworkImage("https://www.marinobeach.com/images/slides/h1-slider1.jpg"),
                    fit: BoxFit.cover
                )
            ),
          ),
